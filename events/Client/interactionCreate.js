    ...
    if (interaction.isCommand() || interaction.isContextMenu()) {
      ...
      try {
        ...
        if (interaction.replied) {
          await interaction
            .editReply({
              content: `Sorry for the inconvenience. If you encounter any issues or errors with our bot, please join our Support Server on Discord at https://discord.gg/evGhPdRJWH to  report the problem. Thank you!`,
            })
            .catch(() => { });
        } else {
          await interaction
